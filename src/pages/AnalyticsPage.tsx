    ...
    <div className="p-8 max-w-6xl animate-fade-in">
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="text-right">
          <div className="stat-number text-2xl font-medium text-foreground">{totalEvents}</div>
          <div className="text-xs text-muted-foreground">событий за период · <span className="text-foreground font-medium">{todayCount}</span> сегодня</div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl p-4 mb-6 space-y-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider w-16">Период</span>
          ...
          {period === 'custom' && (
            <div className="flex items-center gap-2">
              <input
                ...
                className="px-3 py-1.5 rounded-lg border border-border bg-background text-foreground text-xs focus:outline-none focus:ring-1 focus:ring-foreground"
              />
        ...
        {/* Остальные фильтры */}
        <div className="flex items-center gap-3 flex-wrap">
          <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider w-16">Фильтры</span>
          <select
            value={filterBranch}
